...
DROP VIEW IF EXISTS [dbo].[vw_Payroll_Sites] 
DROP VIEW IF EXISTS [dbo].[vw_Payroll_Comments]
DROP VIEW IF EXISTS [dbo].[vw_Payroll_Payroll_Weeks]
DROP VIEW IF EXISTS [Accounting].[vw_Payroll_Aggregate]
GO
